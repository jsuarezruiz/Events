...
namespace XamarinForms3DCarSample
{
    ...
    /// </summary>
    public class RotateToShortest3DGameAction : Vector3AnimationGameAction
    {
        /// <summary>
        /// The transform 3D
        /// </summary>
        ...
        public RotateToShortest3DGameAction(Entity entity, Vector3 to, TimeSpan time, EaseFunction ease = EaseFunction.None, bool local = false, bool shorterPath = false)
