...
namespace TipCalc.UITests
{
    ...
    public class TipCalculationTests
    {
        ...
        public void CalculateTip()
        {
            ...
            var tipAmount = decimal.Parse(_app.Query(e => e.Marked("TipAmount")).Single().Text.Substring(1).Replace(".", ","));
            var total = decimal.Parse(_app.Query(e => e.Marked("Total")).Single().Text.Substring(1).Replace(".", ","));
